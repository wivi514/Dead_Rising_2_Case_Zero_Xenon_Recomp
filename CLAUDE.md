...
**THE FULL NUMBERED LEDGER IS `docs/gotchas.md` — 343 entries, and every "gotcha N"
...
- `docs/` — the project's memory. **Read in this order for a new session:**
  ...
  - **`gotchas.md`** — the 343-entry transferable ledger. Every "gotcha N" resolves here.
...
noticed: this file is loaded into every session whole, and the cost is not its size, it is
