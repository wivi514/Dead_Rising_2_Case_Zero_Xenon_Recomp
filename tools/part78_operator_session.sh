...
OUT="$HOME/DR2CZ-troubleshooting/part78-operator"
mkdir -p "$OUT"
...
echo
echo "  WHAT I MOST WANT FROM THIS RUN: a big crowd, held for a while, and your"
echo "  impression of the FRAME RATE rather than of stutter."
echo
echo "  Part 78 narrowed every image barrier this renderer issues from ALL_COMMANDS to the"
echo "  dependency its layouts actually imply. On my route that is -11.9% at crowd load"
echo "  (94.9 -> 107.6 fps) and -16.4% in the menus, and the whole saving is on the GPU."
echo "  YOUR crowd was CPU-bound above ~8,000 draws in part 76, so it may reach you at a"
echo "  smaller size or not at all — that is the question."
echo
echo "  Nothing about this change can alter a pixel. If the picture differs anywhere from"
echo "  the last session, that is a defect and I want to know exactly where."
echo
