...
const CustomBool kCustomBools[] = {
    ...
    {4, "SHOW FRONTEND SCREEN INFO",       0x82A57BF1},
    {4, "SHOW LOADING TIMES",              0x82A57C08},
    {4, "SHOW GUIDE ARROW DEBUG INFO",     0x82A57CD9},
    {4, "EVERYTHING UNLOCKED FOR MISSIONS",0x82A57CD8},
    {4, "SHOW ALL NOTEBOOK ENTRIES",       0x82A57BF3},
    {4, "BUTTON THROUGH TIMED DIALOGS",    0x82A57C02},
    {4, "DISABLE TUTORIALS",               0x82A57CE0},
    {4, "DISABLE MOVIES",                  0x82A57CD3},
    {4, "DISABLE CASE FILE POPUPS",        0x82A57BF2},
    {4, "DISABLE LEVEL UP MESSAGE",        0x82A57BF4},
